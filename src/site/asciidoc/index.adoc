= JSON-FG Part 1 v1.0 Conformance Test Suite
...
`org.opengis.cite.jsonfg10`. A conformance class corresponds to a &lt;test&gt; element, each
...
|Conformance Level 1
|org.opengis.cite.jsonfg10.level1.*

|Conformance Level 2
|org.opengis.cite.jsonfg10.level2.*
