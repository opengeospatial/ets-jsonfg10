...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tns="http://www.opengis.net/cite/jsonfg10"
  xmlns:saxon="http://saxon.sf.net/"
  xmlns:tec="java:com.occamlab.te.TECore"
  xmlns:tng="java:org.opengis.cite.jsonfg10.TestNGController">

  <ctl:function name="tns:run-ets-jsonfg10">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the jsonfg10 ${version} test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:suite name="tns:ets-jsonfg10-${version}">
     <ctl:title>JSON-FG Part 1 v1.0 Conformance Test Suite</ctl:title>
   ...
   <ctl:test name="tns:Main">
	  ...
	  <ctl:code>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-jsonfg10">
